...
* Alternatively, you can install the [KNIME Node Wizard](https://www.knime.com/developer/documentation/wizard) into your Eclipse Installation from our [Update site (Category: KNIME Development)](http://update.knime.org/analytics-platform/nightly).
