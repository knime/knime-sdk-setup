...
For example, KNIME Analytics Platform 4.7.0 was released in December 2022, so its corresponding release line branch is `releases/2022-12`.
...
For example, repositories containing code which is released as part of KNIME Analytics Platform version 4.7.0
have the tag `analytics-platform/4.7.0`.
...
| 5.1                                    | `releases/2023-07`  | [2023-03](https://www.eclipse.org/downloads/packages/release/2023-03/r/eclipse-ide-rcp-and-rap-developers)     |
| __4.7__                                | `releases/2022-12`  | [__2022-06__](https://www.eclipse.org/downloads/packages/release/2022-06/r/eclipse-ide-rcp-and-rap-developers) |
...
For Apple Silicon (M1, M2, etc. family of processors), use x86\_64 builds (under Rosetta 2) for now and download the
corresponding JDK build _and_ the matching Eclipse build.
Both have to be built for the same architecture, x86\_64 (sometimes abbreviated as x64),
since otherwise some native libraries might not be properly resolved.
